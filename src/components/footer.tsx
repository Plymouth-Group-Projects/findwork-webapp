...
export default function Footer() {
  ...
  return (
    <div className="text-white z-50 bg-darkest py-10 px-6 sm:px-8 lg:px-16">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 lg:gap-10 mt-6 lg:mt-0">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><Link href="/about-us" className="text-sm hover:text-lightest transition-colors">About Us</Link></li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li><Link href="/contact-us" className="text-sm hover:text-lightest transition-colors">Contact Us</Link></li>
              </ul>
            </div>
          </div>
